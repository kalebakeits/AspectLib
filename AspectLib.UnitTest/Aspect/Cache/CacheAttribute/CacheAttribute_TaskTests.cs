...
public class CacheAttribute_TaskTests : BaseCacheAttributeTests
{
    [Fact(DisplayName = "Advised Task - Retrieves Result From Cache")]
    ...
    [Fact(DisplayName = "Advised Task - Retrieves Result From Context")]
    ...
    [Fact(DisplayName = "Advised Task - Returns Interface Type From Cache")]
    public async Task Returns_Interface()
    {
        ...
        [Cache]
        Task<ICustomInstanceInterface> method()
        {
            this.DummyField++;
            ICustomInstanceInterface customInterface = new CustomInstanceClass() { Number = 42 };
            return Task.FromResult(customInterface);
        }
    ...
    [Fact(DisplayName = "Advised Task - Returns Complex Class Type")]
    public async Task Returns_CustomClass()
    {
        ...
        [Cache]
        Task<CustomInstanceClass> method()
        {
            this.DummyField++;
            return Task.FromResult(new CustomInstanceClass { Number = 42 });
        }
    ...
    [Fact(
        DisplayName = "Advised Task - Returns Interface Collection Type (IDictionary<string,string>)"
    )]
    public async Task Returns_InterfaceCollectionType()
    {
        ...
        [Cache]
        Task<IDictionary<string, string>> method()
        {
            this.DummyField++;
    ...
    [Fact(
        DisplayName = "Advised Task - Returns Concrete Collection Type (Dictionary<string,string>)"
    )]
    public async Task Returns_ConcreteCollectionType()
    {
        ...
        [Cache]
        Task<Dictionary<string, string>> method()
        {
            this.DummyField++;
    ...
    [Fact(DisplayName = "Advised Task - Throws Exception and Does Not Cache")]
